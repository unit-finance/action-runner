...
# Reset credsStore to empty so amazon-ecr-credential-helper doesn't become the
# default Docker credential backend. Without this, docker/login-action fails
# with "not implemented" on ARC runners because the ecr-login helper intercepts
# all credential operations. The binary remains available for explicit use.
